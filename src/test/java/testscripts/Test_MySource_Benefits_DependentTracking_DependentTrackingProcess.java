...
public class Test_MySource_Benefits_DependentTracking_DependentTrackingProcess {
    
    @Test
    public void test_MySource_Benefits_DependentTracking_DependentTrackingProcess()
	    throws Exception {
	int rowCount_TestData = 0,columnindex;	
	String FilePath = null,AppURL;
	String FileName = "MySource_Benefits_DependentTracking_DependentTrackingProcess.xls";	
	...
	FilePath = "TestData//TopHitPages//BackOffice_Benefits//";
	FileInputStream TestInputDataStream = new FileInputStream(new File(
		System.getProperty("user.dir") + "//TestData//TopHitPages//BackOffice_Benefits//"
			+ FileName));
